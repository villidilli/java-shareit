...
public class BookingServiceIntegrationTest {
    ...
    public void getAllByBooker() {
        ...
        List<BookingResponseDto> actualListAll =
                                bookingService.getAllByBooker(savedUser1.getId(), ALL.name(), 0, 2);
        ...
        List<BookingResponseDto> actualListCurrent =
                                bookingService.getAllByBooker(savedUser1.getId(), CURRENT.name(), 0, 2);
        ...
        List<BookingResponseDto> actualListPast =
                                bookingService.getAllByBooker(savedUser1.getId(), PAST.name(), 0, 2);
        ...
        List<BookingResponseDto> actualListFuture =
                                bookingService.getAllByBooker(savedUser1.getId(), FUTURE.name(), 0, 2);
        ...
        List<BookingResponseDto> actualListWaiting =
                                bookingService.getAllByBooker(savedUser1.getId(), WAITING.name(),0, 2);
        ...
        List<BookingResponseDto> actualListRejected =
                                bookingService.getAllByBooker(savedUser1.getId(), REJECTED.name(),0, 2);
