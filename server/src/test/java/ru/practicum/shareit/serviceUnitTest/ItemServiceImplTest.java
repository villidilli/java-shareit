...
public class ItemServiceImplTest {
    ...
    public void createItem_ReturnSavedItem() {
        ...
        ItemDto actualDto = itemService.create(itemDto1, 1L);
    ...
    public void createComment_thenReturnSavedComment() {
        ...
        CommentDto actual = itemService.createComment(commentDto, item1.getId(), user2.getId());
    ...
    public void createComment_whenItemNotFound_thenNotFoundExceptionThrow() {
        NotFoundException actual = assertThrows(NotFoundException.class,
                () -> itemService.createComment(commentDto, item1.getId(), user2.getId()));
