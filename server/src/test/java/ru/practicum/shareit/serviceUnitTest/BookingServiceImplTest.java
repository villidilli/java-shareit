...
public class BookingServiceImplTest {
    ...
    public void createBooking() {
        ...
        BookingResponseDto actualDto = bookingService.create(bookingReqDto1, 2L);
    ...
    public void createBookingBookerNotFound() {
        ...
        NotFoundException actualException =
                assertThrows(NotFoundException.class, () -> bookingService.create(bookingReqDto1, 1L));
    ...
    public void createBookingItemNotAvailable() {
        ...
        ValidateException actualException =
                assertThrows(ValidateException.class, () -> bookingService.create(bookingReqDto1, 2L));
