...
public class ItemRequestServiceImplTest {
    ...
    public void beforeEach() {
        ...
        item = new Item(1L, user1, "name", "desc", true, request);
    }
    ...
    public void createRequest_thenReturnCreatedRequest() {
        ...
        ItemRequestDto actual = requestService.create(requestDto1, user1.getId());
    ...
    public void createRequest_whenUserNotFound_thenNotFoundExceptionThrow() {
        ...
        NotFoundException actual = assertThrows(NotFoundException.class,
                () -> requestService.create(requestDto1, user1.getId()));
    ...
    public void getAllOwn_whenRequestFound_thenReturnListRequests() {
        ...
        when(itemStorage.findByRequest_IdIn(anyList())).thenReturn(List.of(item));
