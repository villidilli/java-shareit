...
public class ItemRequestControllerTest {
    ...
    public void createRequest_whenUserNotFound_thenNotFoundExceptionThrow() {
        ...
        verify(requestService, times(1))
                .create(any(ItemRequestDto.class), anyLong());
    }

    @SneakyThrows
    @Test
    public void getAllOwn_thenReturnListRequests() {
        when(requestService.getAllOwn(userId)).thenReturn(List.of(responseDto));
    ...
    public void getAllNotOwn_whenFromAndSizeNotInput_thenReturnListRequests() {
        when(requestService.getAllNotOwn(anyLong(), anyInt(), anyInt())).thenReturn(List.of(responseDto));
    ...
    public void getById_thenReturnRequest() {
        when(requestService.getById(userId, requestDto.getId())).thenReturn(responseDto);
